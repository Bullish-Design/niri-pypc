...
class WindowLayout(ProtocolModel):
    pos_in_scrolling_layout: tuple[int, int] | None = None
    tile_pos_in_workspace_view: tuple[float, float] | None = None
...
LayoutSwitchTarget.model_rebuild()
ModeToSet.model_rebuild()
OutputAction.model_rebuild()
PositionChange.model_rebuild()
PositionToSet.model_rebuild()
ScaleToSet.model_rebuild()
SizeChange.model_rebuild()
WorkspaceReferenceArg.model_rebuild()
ConfiguredMode.model_rebuild()
ConfiguredPosition.model_rebuild()
KeyboardLayouts.model_rebuild()
LayerSurface.model_rebuild()
LogicalOutput.model_rebuild()
Mode.model_rebuild()
Output.model_rebuild()
Overview.model_rebuild()
PickedColor.model_rebuild()
Timestamp.model_rebuild()
VrrToSet.model_rebuild()
Window.model_rebuild()
WindowLayout.model_rebuild()
